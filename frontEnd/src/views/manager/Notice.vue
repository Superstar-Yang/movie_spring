<template>
  <div>
    ...
    <div class="card" style="margin-bottom: 5px;">
      <el-input v-model="data.title" style="width: 300px; margin-right: 10px" placeholder="请输入公告标题查询"></el-input>
    ...
    <div class="card">
      <el-pagination background :page-sizes=[10,20,30,40] layout=" sizes, prev, pager, next, jumper,->,total" v-model:page-size="data.pageSize" v-model:current-page="data.pageNum" :total="data.total"/>
    </div>
