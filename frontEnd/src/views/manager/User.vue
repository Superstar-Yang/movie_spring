<template>
  <div>
      ...
      <el-table :data="data.tableData" stripe>
        ...
        <el-table-column label="角色" prop="role">
          <template #default="scope">
            ...
            <span v-if="scope.row.role === 'ROLE_USER'">普通用户</span>
          </template>
        </el-table-column>
    ...
    <div class="card">
      <el-pagination background :page-sizes=[10,20,30,40] layout="prev, pager, next" v-model:page-size="data.pageSize" v-model:current-page="data.pageNum" :total="data.total"/>
    </div>
